...
//   const navigation = useNavigation();
  const navigation = useNavigation<StackNavigationProp<RootParamList, 'SelectDropOnMapScreen'>>(); // Type the navigation
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Button title="Confirm Drop Location" onPress={handleConfirmLocation} color="#fcba03" />
      </View>
    </View>
  );
};
